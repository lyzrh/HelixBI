...
const STR = {
  zh: {
    ...
    'wb.mConn': '数据连接',
    'wb.mConnDesc': '上传 CSV / Excel / JSON / Parquet，或连接 MySQL / PostgreSQL / SQLite（物化后分析）',
    ...
    // 使用指南
    'wb.g1': '连接数据', 'wb.g1Desc': '上传 CSV / Excel / JSON / Parquet 文件，或配置数据库连接并物化为缓存',
  ...
  en: {
    ...
    'wb.mConnDesc': 'Upload CSV / Excel / JSON / Parquet, or connect MySQL / PostgreSQL / SQLite (materialized for analysis)',
    ...
    'wb.g1': 'Connect Data', 'wb.g1Desc': 'Upload CSV / Excel / JSON / Parquet files, or configure database connections (materialized to cache)',
